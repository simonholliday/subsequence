...
- **PatternBuilder** provides high-level musical verbs (`note`, `hit`, `fill`, `arpeggio`, `chord`, `euclidean`, `bresenham`, `dropout`, `swing`, `velocity_shape`).
