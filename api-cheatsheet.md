...
| `lorenz_attractor(steps, dt, sigma, rho, beta, x0, y0, z0, start) -> List[Tuple[float, float, float]]` | Integrate the Lorenz attractor and return normalised (x, y, z) tuples. |
