...
def drums(p):
    ...
    # ═══════════════════════════════════════════════════════════════════
        ...
        p.cellular_1d(
            "kick_1", rule=30, velocity=38, no_overlap=True, probability=ca_probability
        )
    ...
    # ═══════════════════════════════════════════════════════════════════
        ...
        p.cellular_1d("kick_1", rule=30, velocity=38, no_overlap=True, probability=0.65)
        ...
        p.cellular_1d(
            "hi_hat_closed", rule=90, velocity=40, no_overlap=True, probability=0.55
        )
