...
def _add_minor_turnaround(
    ...
    supertonic = subsequence.chords.Chord(
        root_pc=supertonic_pc, quality="half_diminished_7th"
    )
...
class TurnaroundModulation(subsequence.chord_graphs.ChordGraph):
    ...
    def __init__(
        self, include_dominant_7th: bool = True, minor_turnaround_weight: float = 0.0
    ) -> None:
    ...
    def build(
        ...
        for key_pc in range(12):
            ...
            _add_minor_turnaround(
                graph, key_pc, self.minor_turnaround_weight, self.include_dominant_7th
            )
