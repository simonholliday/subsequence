...
RpnParameter = typing.Literal[
	...
	"sound_3d_azimuth_angle",
	"sound_3d_distance_ratio",
	"sound_3d_elevation_angle",
	"sound_3d_gain",
	"sound_3d_gain_at_maximum_distance",
	"sound_3d_maximum_distance",
	"sound_3d_pan_spread_angle",
	"sound_3d_reference_distance_ratio",
	"sound_3d_roll_angle",
	"tuning_bank_select",
