...
SCALE_MODE_MAP: typing.Dict[
    str, typing.Tuple[str, typing.Optional[typing.List[str]]]
] = {
...
_BUILTIN_SCALE_NAMES: typing.FrozenSet[str] = frozenset(
    INTERVAL_DEFINITIONS
) | frozenset(SCALE_MODE_MAP)
...
def get_diatonic_intervals(
    ...
    for i in range(num_scale_notes):
        if mode == "scale":
            chord = [
                scale_notes[(i + offset) % num_scale_notes] for offset in intervals
            ]
