...
class Pattern:
	...
	def __init__ (self, channel: int, length: int = 16, time_signature: typing.Tuple[int, int] = (4, 4)) -> None:

		"""
		Initialize a new pattern with MIDI channel, length in beats, and time signature.
		"""
