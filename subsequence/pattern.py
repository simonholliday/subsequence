...
class Note:
    ...
    origin: typing.Optional[str] = (
        None  # Original drum-name string (if the pitch was named), kept so mirror destinations can re-resolve it through their own drum_note_map.  None for numeric/pitched notes.
    )
...
class CcEvent:
    ...
    channel: typing.Optional[int] = (
        None  # If set, overrides pattern.channel for this event
    )
    device: typing.Optional[int] = (
        None  # If set, overrides pattern.device for this event
    )
...
class RawNoteEvent:
    ...
    velocity: int = 0
    origin: typing.Optional[str] = (
        None  # Original drum-name string, kept so mirror destinations re-resolve it through their own drum_note_map (same contract as Note.origin)
    )
...
class Pattern:
    ...
    def __init__(
        ...
        device: int = 0,
        mirrors: typing.Optional[typing.Iterable[MirrorSpec]] = None,
    ) -> None:
        """
    ...
    def add_note_beats(
        ...
        pulses_per_beat: int = subsequence.constants.MIDI_QUARTER_NOTE,
        origin: typing.Optional[str] = None,
        primary_unmapped: bool = False,
    ) -> None:
        """
    ...
    def add_sequence_beats(
        ...
        note_duration_beats: float = 0.25,
        pulses_per_beat: int = subsequence.constants.MIDI_QUARTER_NOTE,
    ) -> None:
        """
