...
class PatternBuilder:
	...
	def __init__ (self, pattern: subsequence.pattern.Pattern, drum_note_map: typing.Optional[typing.Dict[str, int]] = None) -> None:

		"""
		Initialize the builder with a pattern and optional drum note map.
		"""
