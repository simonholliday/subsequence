...
def _fake_open_input(
    name: str, callback: typing.Optional[typing.Callable] = None
) -> FakeMidiIn:
...
def _make_multi_output_patcher(device_names: typing.List[str]) -> typing.Callable:
    ...
    ports: typing.Dict[str, NamedSpyMidiOut] = {
        n: NamedSpyMidiOut(n) for n in device_names
    }
...
@pytest.fixture
def patch_midi_multi(
    monkeypatch: pytest.MonkeyPatch,
) -> typing.Dict[str, NamedSpyMidiOut]:
