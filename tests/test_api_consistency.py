...
def test_inverted_generator_draws_nothing_at_default_probability(
    place: typing.Callable,
) -> None:
...
def test_cellular_2d_center_is_the_default() -> None:
    ...
    b_explicit.cellular_2d(
        [36, 38, 42], velocity=100, generation=0, initial_state="center"
    )
...
def test_cellular_2d_random_is_reproducible_with_seed() -> None:
    ...
    b1.cellular_2d(
        [36, 38, 42], velocity=100, generation=3, initial_state="random", seed=7
    )
    b2.cellular_2d(
        [36, 38, 42], velocity=100, generation=3, initial_state="random", seed=7
    )
