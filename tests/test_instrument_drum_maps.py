...
def test_drm1_native_names_unchanged () -> None:
	...
	for name in ("kick", "snare", "clap", "drum_1", "drum_2", "multi",
...
def test_drm1_approximations_removed () -> None:
	...
	for name in ("side_stick", "low_tom", "low_floor_tom", "high_tom",
	             "crash_1", "crash_2", "splash_cymbal", "chinese_cymbal",
	             "ride_1", "ride_2", "ride_bell", "tambourine", "cabasa",
	             "maracas", "shaker", "cowbell", "claves", "high_woodblock",
	             "low_bongo", "mute_high_conga", "high_agogo", "vibraslap"):
...
def test_tr8s_omits_absent_voices () -> None:
	...
	for name in ("cowbell", "tambourine", "splash_cymbal", "chinese_cymbal",
	             "ride_bell", "low_conga", "high_bongo", "claves", "shaker",
	             "short_guiro", "mute_triangle"):
		assert name not in m
