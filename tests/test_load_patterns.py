...
def test_load_patterns_uses_source_label_in_compile_error (patch_midi: None) -> None:
	...
	with pytest.raises(SyntaxError) as exc_info:
		composition.load_patterns("def drums(p): :::", source_label="uploaded-session-abc")
...
@pytest.mark.asyncio
async def test_load_patterns_post_play_runtime_error_propagates (patch_midi: None) -> None:
