...
def _assert_no_dead_ends(
    graph_obj: subsequence.chord_graphs.ChordGraph, key: str
) -> int:
...
def _assert_stepping_stable(style: str, key: str = "C", steps: int = 50) -> None:
    ...
    state = subsequence.harmonic_state.HarmonicState(
        key_name=key, graph_style=style, key_gravity_blend=0.8
    )
...
class TestLydianMajor:
    ...
    def test_no_natural_iv(self) -> None:
        ...
        while queue:
            ...
            assert current != natural_iv, (
                "Natural IV should not appear in a Lydian graph"
            )
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="C", graph_style="lydian_major"
        )
...
class TestDorianMinor:
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="D", graph_style="dorian_minor"
        )
...
class TestChromaticMediant:
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="C", graph_style="chromatic_mediant"
        )
...
class TestSuspended:
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="A", graph_style="suspended"
        )
...
class TestMixolydian:
    ...
    def test_no_dominant_major(self) -> None:
        ...
        while queue:
            ...
            assert current != dominant_major, (
                "V major should not appear in a Mixolydian graph"
            )
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="C", graph_style="mixolydian"
        )
...
class TestWholeTone:
    def test_all_augmented(self) -> None:
        ...
        while queue:
            ...
            assert current.quality == "augmented", (
                f"Expected augmented, got {current.quality}"
            )
    ...
    def test_fully_connected(self) -> None:
        ...
        while queue:
            ...
            assert len(transitions) == 5, (
                f"Expected 5 transitions, got {len(transitions)}"
            )
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="C", graph_style="whole_tone"
        )
...
class TestDiminished:
    ...
    def test_string_name(self) -> None:
        ...
        state = subsequence.harmonic_state.HarmonicState(
            key_name="C", graph_style="diminished"
        )
