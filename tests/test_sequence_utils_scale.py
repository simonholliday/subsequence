...
def test_scale_clamp_basics () -> None:
...
def test_scale_clamp_clamping () -> None:
...
def test_scale_clamp_reversed_output () -> None:
...
def test_scale_clamp_reversed_input () -> None:
